...
OptSoftware::OptSoftware(char buf[], int length)
{
	if (length < 0)
		return;
...
std::wstring OptSoftware::StringToWString(const std::string& str)
{
...
std::string OptSoftware::WStringToString(const std::wstring &wstr)
{
	std::string str;
