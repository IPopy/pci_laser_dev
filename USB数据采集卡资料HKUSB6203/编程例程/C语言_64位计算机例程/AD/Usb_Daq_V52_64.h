...
USB_DAQ_V52_DLL_API  int __stdcall  ad_continu_conf(int dev,int ad_os,int ad_range,int ch_first,int ch_last,int freq,int trig_sl,int trig_pol,int clk_sl,int ext_clk_pol);
...
USB_DAQ_V52_DLL_API  int __stdcall ad_continu(int dev,int ad_os,int ad_range,int ch_first,int ch_last,int freq,int trig_sl,int trig_pol,int clk_sl,int ext_clk_pol,int num,float* databuf);
